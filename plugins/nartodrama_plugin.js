...
function getManifest() {
    return JSON.stringify({
        ...
        "description": "Bản Webview: Vuốt dọc tự chuyển tập, Auto xoay dọc, Chặn Quảng Cáo, Fix lỗi iOS",
        "version": "1.2.0",
...
// -----------------------------------------------------------------------------
// GIỮ NGUYÊN HOÀN TOÀN CẤU TRÚC DANH MỤC (Sửa lại đúng chuẩn Narto)
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// ĐÃ SỬA: FIX LỖI REGEX iOS VÀ TỐI ƯU HÓA 1 LINK DUY NHẤT CHO WEBVIEW
// -----------------------------------------------------------------------------
function parseMovieDetail(html, url) {
    try {
        ...
        servers.push({
            ...
            episodes: [{
                id: watchLink, // Mở luôn link xem phim vào Webview
    ...
    try {
        var killAdsCssJs = `
            (function() {
                ...
                // Ẩn tất cả Header, Footer, Thanh Bottom-Nav, Popup Quảng cáo... Chỉ giữ lại giao diện Video
                ...
                setInterval(function() {
                    // Xóa các banner yêu cầu tải app làm che mất video
                    ...
                    // Tự động nhấn tắt nút Close popup
        ...
        return JSON.stringify({
            "url": url,
            "isEmbed": true, // BẮT BUỘC ĐỂ ÉP MỞ BẰNG GIAO DIỆN TIKTOK CỦA VAX
            "headers": {
                "Referer": BASEURL,
