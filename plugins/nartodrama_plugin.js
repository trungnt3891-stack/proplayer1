...
function getManifest() {
    return JSON.stringify({
        ...
        "description": "Bản Webview: Vuốt dọc tự chuyển tập, Chặn Quảng Cáo, Fix Lỗi Ảnh Bìa/Không Load",
        "version": "1.2.0",
...
function parseListResponse(html, $url) {
    try {
        ...
        while ((match = regex.exec(html)) !== null) {
            ...
            // LƯU Ý QUAN TRỌNG: KHÔNG APPEND THÊM /1 VÀO CUỐI NHƯ CODE CŨ NỮA ĐỂ TRÁNH LỖI 404
...
// -----------------------------------------------------------------------------
// ĐÃ SỬA: CHỈ TRẢ VỀ DUY NHẤT 1 LINK WEBVIEW ĐỂ TỰ LƯỚT
// -----------------------------------------------------------------------------
function parseMovieDetail(html, url) {
    try {
        ...
        servers.push({
            ...
            episodes: [{
                id: url, // TRUYỀN NGUYÊN LINK VÀO WEBVIEW
...
// -----------------------------------------------------------------------------
// ĐÃ SỬA: ÉP WEBVIEW VÀ TIÊM SCRIPT ẨN SẠCH QUẢNG CÁO, THANH ĐIỀU HƯỚNG
// -----------------------------------------------------------------------------
    ...
    try {
        ...
        var killAdsCssJs = `
            (function() {
                ...
                // Ẩn Header Topbar, Footer, Popup Đăng nhập, Quảng cáo Adsterra...
                ...
                setInterval(function() {
                    // Xóa các hộp thoại rác, lịch sử xem tự động nhảy lên
