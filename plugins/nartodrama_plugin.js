...
function getManifest() {
    return JSON.stringify({
        ...
        "description": "Bản Webview: Vuốt dọc tự chuyển tập, Auto xoay dọc, Chặn Quảng Cáo, Fix lỗi Trang chủ",
        "version": "1.3.0",
...
// =============================================================================
// PARSERS TRÂU BÒ CHO IOS (LOẠI BỎ SỰ PHỤ THUỘC VÀO DOM ẢO GÂY LỖI TRANG CHỦ)
// =============================================================================
...
function parseListResponse(html, $url) {
    try {
        ...
        // Phương pháp 2: Fallback bằng DOM Ảo (dành cho các layout phụ)
        if (items.length === 0) {
...
// -----------------------------------------------------------------------------
// XỬ LÝ TRANG CHI TIẾT: KHÔNG CẮT GHÉP URL NỮA. CHỈ TRẢ VỀ DUY NHẤT 1 LINK VÀO WEBVIEW
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// ÉP WEBVIEW VÀ TIÊM JAVASCRIPT/CSS ĐỂ XÓA MỌI RÁC, HEADER, QUẢNG CÁO
// -----------------------------------------------------------------------------
