...
/movies?sort=year_desc&limit=24&category=hanh-dong@@Hành Động@@true
/movies?sort=year_desc&limit=24&category=kinh-di@@Kinh Dị@@true
/movies?sort=year_desc&limit=24&category=tinh-cam@@Tình Cảm@@true
/movies?sort=year_desc&limit=24&category=hai-huoc@@Hài Hước@@true
`;
