...
function getManifest() {
	return JSON.stringify({
		"id": "onflix",
		"name": "Onflix",
		"description": "Bản Master Ổn Định: Thay đổi domain dễ dàng, Bỏ Nguồn C, Chặn QC.",
		"version": "2.3.2", 
		"baseUrl": BASEURL,
...
function getHomeSections() {
    return JSON.stringify([
        { "slug": "/movies?sort=newest&limit=24", "title": "Phim Mới", "type": "Grid" },
        ...
        { "slug": "/movies?sort=year_desc&limit=24&category=co-trang", "title": "Cổ Trang", "type": "Horizontal" },
    ...
    try {
        ...
        if ($listEpi && Array.isArray($listEpi)) {
            $listEpi.forEach(episode => {
                ...
                // ==============================================================
                // XÓA "NGUỒN C": Nếu tên server chứa chữ NC hoặc Nguồn C thì bỏ qua
                // ==============================================================
                if (rawServerName.includes("NC") || rawServerName.toLowerCase().includes("nguồn c")) {
                    return; // Lệnh return này sẽ trực tiếp skip sang vòng lặp kế tiếp
                }
