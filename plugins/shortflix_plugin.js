...
function getManifest() {
    return JSON.stringify({
        ...
        "description": "Đã Kích Hoạt Vuốt Dọc Chuyển Tập & Tối Ưu Trang Chủ",
        "version": "1.3.0", // Đổi version để ép App xóa cache cũ
        ...
        "layoutType": "VERTICAL",      // BẮT BUỘC ĐỂ ÉP MÀN HÌNH XOAY DỌC
...
// CHỈ ĐỂ 5 MỤC NỔI BẬT RA TRANG CHỦ THEO YÊU CẦU (Chống lag)
function getHomeSections() {
    return JSON.stringify([
        ...
        { "slug": "&genre=tong-tai", "title": "Tổng Tài", "type": "Horizontal" },
        { "slug": "&genre=ngon-tinh", "title": "Ngôn Tình", "type": "Horizontal" },
        { "slug": "&genre=co-dai", "title": "Cổ Đại", "type": "Horizontal" }
    ]);
}

// CÁC MỤC CÒN LẠI ĐƯỢC GIẤU VÀO MENU CATEGORIES
