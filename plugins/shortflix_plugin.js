...
function getManifest() {
    return JSON.stringify({
        ...
        "description": "Bản Master: Code Gốc Android, Tự Động Vuốt Dọc TikTok, 5 Mục Trang Chủ",
        "version": "2.6.0", // Đổi version để ép App xóa cache
        "info": "Vuốt lên/xuống để chuyển tập mượt mà.",
        "baseUrl": BASEURL,
        "iconUrl": "https://raw.githubusercontent.com/alokillgtv-gif/VAXAPPSCRIPT/main/img/shortflix.png",
        "isEnabled": true,
        "isAdult": false,
        "type": "shortfilm",           // BẮT BUỘC ĐỂ KÍCH HOẠT VUỐT DỌC TIKTOK
        "layoutType": "VERTICAL",      // Ép giao diện xoay dọc
        "playerType": "exoplayer"      // Phát Native trực tiếp
    });
}
...
// 1. CHỈ ĐỂ 5 MỤC NỔI BẬT Ở TRANG CHỦ THEO YÊU CẦU
...
// 2. GIẤU TOÀN BỘ CÁC DANH MỤC VÀO TRONG MENU THỂ LOẠI
function getPrimaryCategories() {
    return JSON.stringify([
        { "name": "Phim Mới", "slug": "&sortBy=last_episode_at" },
        { "name": "Âm Nhạc", "slug": "&genre=am-nhac" },
        { "name": "Bí Ẩn", "slug": "&genre=bi-an" },
        { "name": "Chiến Tranh", "slug": "&genre=chien-tranh" },
        { "name": "Chính Kịch", "slug": "&genre=chinh-kich" },
        { "name": "Chương Trình Truyền Hình", "slug": "&genre=chuong-trinh-truyen-hinh" },
        { "name": "Đang Cập Nhật", "slug": "&genre=dang-cap-nhat" },
        { "name": "Gây Cấn", "slug": "&genre=gay-can" },
        { "name": "Gia Đình", "slug": "&genre=gia-dinh" },
        { "name": "Giả Tưởng", "slug": "&genre=gia-tuong" },
        { "name": "Hài Hước", "slug": "&genre=hai-huoc" },
        { "name": "Hành Động", "slug": "&genre=hanh-dong" },
        { "name": "Học Đường", "slug": "&genre=hoc-duong" },
        { "name": "Huyền Huyễn", "slug": "&genre=huyen-huyen" },
        { "name": "Khoa Học", "slug": "&genre=khoa-hoc" },
        { "name": "Kinh Dị", "slug": "&genre=kinh-di" },
        { "name": "Kinh Điển", "slug": "&genre=kinh-dien" },
        { "name": "Lãng Mạn", "slug": "&genre=lang-man" },
        { "name": "LGBT", "slug": "&genre=lgbt" },
        { "name": "Lịch Sử", "slug": "&genre=lich-su" },
        { "name": "Miền Tây", "slug": "&genre=mien-tay" },
        { "name": "Phim Hài", "slug": "&genre=hai" },
        { "name": "Phim Ngắn", "slug": "&genre=ngan" },
        { "name": "Phim Nhạc", "slug": "&genre=nhac" },
        { "name": "Short Drama", "slug": "&genre=short-drama" },
        { "name": "Sitcom", "slug": "&genre=sitcom" },
        { "name": "Tài Liệu", "slug": "&genre=tai-lieu" },
        { "name": "Talk", "slug": "&genre=talk" },
        { "name": "Tâm Lý", "slug": "&genre=tam-ly" },
        { "name": "Thần Thoại", "slug": "&genre=than-thoai" },
        { "name": "Thần Tượng", "slug": "&genre=than-tuong" },
        { "name": "Thể Thao", "slug": "&genre=the-thao" },
        { "name": "Tiên Hiệp", "slug": "&genre=tien-hiep" },
        { "name": "Tình Cảm", "slug": "&genre=tinh-cam" },
        { "name": "Tình Tiết", "slug": "&genre=tinh-tiet" },
        { "name": "Tình Yêu Ngọt Ngào", "slug": "&genre=tinh-yeu-ngot-ngao" },
        { "name": "Tội Phạm", "slug": "&genre=toi-pham" },
        { "name": "Trẻ Em", "slug": "&genre=tre-em" },
        { "name": "Viễn Tưởng", "slug": "&genre=vien-tuong" },
        { "name": "Võ Thuật", "slug": "&genre=vo-thuat" },
        { "name": "Phim 18+", "slug": "&genre=18-plus" }
    ]);
}
...
function getUrlList(slug, filtersJson) {
    try {
        var page = 1;
        var path = slug || "&sortBy=last_episode_at"; // Đường dẫn mặc định
        var cursor = "";
...
// =============================================================================
// PARSERS (GIỮ NGUYÊN 100% TỪ MÃ ANDROID BẠN ĐƯA)
// =============================================================================
...
function parseMovieDetail(html, url) {
    try {
        ...
        for (var $j = 0; $j < $listepi.length; $j++) {
            ...
            // Xử lý tập 0 -> Trailer để hiển thị đẹp hơn
            var $nameepi = $epinumber === 0 ? "Trailer / Tập 0" : "Tập " + $epinumber;
...
function parseDetailResponse(html, url) {
    try {
        ...
        var tapcurrent = $episodes.findIndex(function(ep) {
            return ep.name == tapVal || ep.slug == tapVal || ep.episodeNumber == tapVal;
        });
...
// BỘ DOM ẢO _$ (GIỮ NGUYÊN TỪ CODE ANDROID)
